...
| web | Vitest component tests for ui primitives; Playwright e2e: load two bots, run to completion, winner overlay visible; editor: type a bot, see lint, step in debugger; theme switch persists |
